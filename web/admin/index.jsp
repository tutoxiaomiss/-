	...
	<div class="header bg-main">
		...
		<div class="head-l" style="float: right; margin-right: 2%;">
			<span style="color: white"><span style="color: lightblue">${message}</span>
				...
				style="color: lightblue;">超级管理员</span></span> <a
	...
	<div class="leftnav">
		...
		<ul style="display: block;">
			<li><a
				...
				target="right"> <span class="icon-caret-right"></span>用户创建
			</a></li>
			<li><a
				href="${pageContext.request.contextPath}/findAllAdmin"
				target="right"> <span class="icon-caret-right"></span>用户列表
			</a></li>
		</ul>
		...
		<ul>
			...
			<li><a
				href="${pageContext.request.contextPath}/findAllLogs"
				target="right"> <span class="icon-caret-right"></span>操作日志列表列表
			</a></li>
		</ul>
