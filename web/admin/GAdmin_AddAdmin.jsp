...
<div class="panel admin-panel">
  <div class="panel-head"><strong><span class="icon-key"></span> 发工资</strong></div>
  ...
  <div class="body-content">
    <form name="form2" method="post" class="form-x" action="${pageContext.request.contextPath}/addWages">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="" name="adminName1" value="${adminName}" size="50" placeholder="请输入员工编号" data-validate="required:请输入员工编号" />
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="" name="adminName2" value="${adminName}" size="50" placeholder="请输入职位" data-validate="required:请输入职位" />
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="" name="adminName3" value="${adminName}" size="50" placeholder="请输入基本工资" data-validate="required:请输入基本工资" />
      ...
      <div class="field">
        <input type="text" class="input w50" value="" name="adminName4" value="${adminName}" size="50" placeholder="请输入考勤工资" data-validate="required:请输入考勤工资" />
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="" name="adminName5" value="${adminName}" size="50" placeholder="请输入公司福利" data-validate="required:请输入公司福利" />
